...
func TestSetCondition_UpdatesReason(t *testing.T) {
	...
	setCondition(&conds, conditionTypeReady, metav1.ConditionTrue, "Initial", "msg")
	...
	setCondition(&conds, conditionTypeReady, metav1.ConditionTrue, "Updated", "msg")
	...
	setCondition(&conds, conditionTypeReady, metav1.ConditionFalse, "Updated", "msg")
